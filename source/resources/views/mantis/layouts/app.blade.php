...
<head>
	...
	<!-- [Favicon] icon -->
	<link rel="icon" href={{ asset('favicon.ico') }} type="image/x-icon"> <!-- [Google Font] Family -->
...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
	...
	<!-- [ Pre-loader ] start -->
	@include('mantis.layouts.loader')
	<!-- [ Pre-loader ] End -->

	<!-- [ Sidebar Menu ] start -->
	@include('mantis.layouts.sidebar')
	<!-- [ Sidebar Menu ] end -->
	...
	<div class="pc-container">
		<div class="pc-content">
			...
			<!-- [ breadcrumb ] start -->
			@include('mantis.layouts.breadcrumb')
			<!-- [ breadcrumb ] end -->
	...
	<script>
		window.srcLogo = "{{ asset('mantis/assets/images/logo-dark.svg') }}";
		window.besogoImagePath = "{{ asset('besogo/img/') }}";
		window.besogoPublicLink = "{{ asset('besogo/') }}";
